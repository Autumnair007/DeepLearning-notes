...
$$
其中 $\Delta_K$ 是 $K$ 维概率单纯形。训练每像素分类模型是直接的：给定每个像素的真实类别标签 $y^{gt} = \{y^{gt}_i | y^{gt}_i \in \{1,...,K\}\}_{i=1}^{H \cdot W}$，通常应用每像素交叉熵（负对数似然）损失：
$$
...
![c02551da9018eac1ee28ad14ff2338bc](maskformer_paper_notes.assets/c02551da9018eac1ee28ad14ff2338bc.png)
